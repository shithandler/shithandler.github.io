...
async function g_converstion(character, deepseek = 0){
  ...
  while(true){
    ...
    if(deepseek){await sendMessage_d(character, gameData.entered)}
    else{await sendMessage(character, gameData.entered)}
